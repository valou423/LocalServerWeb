<nav id="menu">        
    <div class="element_menu">
        <h2>Menu</h2>
        <ul>
            <li><a href="Ressource/Laura/Laura.php">La page de laura</a></li>
            <li><a href="Ressource/Valentin/Valentin.php">La page de Valentin</a></li>
            <li><a href="Ressource/Philippe/Philippe.php">La page de Philippe</a></li>
